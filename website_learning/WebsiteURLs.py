...
class TestWebsite(WebsiteURLs):
    def __init__(self):
        ...
        urls_in_scope = [
            "https://lklamb.github.io/Test_Website/index.html",
...
class OutputExample(WebsiteURLs):
    def __init__(self):
        ...
        urls_in_scope = [
            "https://lklamb.github.io/Test_Website/output-example_page1.html",
...
class RunningExample(WebsiteURLs):
    def __init__(self):
        ...
        urls_in_scope = [
            "https://lklamb.github.io/Test_Website/running-example_page1.html",
...
class HoverExample(WebsiteURLs):
    def __init__(self):
        ...
        urls_in_scope = [
            "https://lklamb.github.io/Test_Website/hover-example_page1.html",
...
class MovingElementsExample(WebsiteURLs):
    def __init__(self):
        initial_url = (
            "https://lklamb.github.io/Test_Website/moving-elements-example_page1.html"
        )
        urls_in_scope = [
            "https://lklamb.github.io/Test_Website/moving-elements-example_page1.html",
        ]
...
class CarAlarmWebsite(WebsiteURLs):
    def __init__(self):
        ...
        urls_in_scope = [
            "https://lklamb.github.io/CarAlarmSystem_Demo/index.html",
